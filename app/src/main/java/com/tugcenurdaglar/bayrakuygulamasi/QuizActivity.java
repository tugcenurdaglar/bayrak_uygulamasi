...
//                finish();////result activitye gittiğimizde back tuşuna bastığımızda
//                // bu sayfa silinmiş olur direk main Activitye geçer
    ...
    public void soruYukle() {
        ...
        yanlisSeceneklerListe = new BayraklarDao().rastgele3YanlisSecenekGetir(
                vt,dogruSoru.getBayrak_id()
        );

        imageViewBayrak.setImageResource(getResources().getIdentifier(
